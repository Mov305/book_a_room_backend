    ...
    path '/api/v1/reservations?user_id=1' do
      ...
      post 'Create a reservation' do
        ...
        parameter name: :reservation, in: :body, schema: {
          ...
          required: %w[start end nights cost room_id user_id]
        }
        response '201', 'reservation created' do
          let(:reservation) do
            { start: '2021-05-01 00:00:00', end: '2021-05-02 00:00:00', nights: 1, cost: 1.0, room_id: 1, user_id: 1 }
          end
          run_test!
        end
        response '422', 'invalid request' do
          let(:reservation) do
            { start: '2021-05-01 00:00:00', end: '2021-05-02 00:00:00', nights: 1, cost: 1.0, room_id: 1 }
          end
          run_test!
        end
      end
    ...
    path '/api/v1/reservations/{id}' do
      get 'Get a reservation' do
        ...
        response '200', 'reservation found' do
          let(:id) do
            Reservation.create(start: '2021-05-01 00:00:00', end: '2021-05-02 00:00:00', nights: 1, cost: 1.0, room_id: 1,
                               user_id: 1).id
          end
          run_test!
        end
