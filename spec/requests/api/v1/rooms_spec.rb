    ...
    path "/api/v1/rooms" do
      ...
      post "Create a room" do
        ...
        parameter name: :room, in: :body, schema: {
                    ...
                    required: ["description", "num", "room_type", "night_cost", "image", "user_id"],
                  }
        response "201", "room created" do
          let(:room) { { description: "test", num: 1, room_type: "test", night_cost: 1.0, image: "test", booked: false, booked_end: nil, user_id: 1 } }
          run_test!
        end
    ...
    path "/api/v1/rooms/{id}" do
      get "Get a room" do
        ...
        response "200", "room found" do
          let(:id) { Room.create(description: "test", num: 1, room_type: "test", night_cost: 1.0, image: "test", booked: false, booked_end: nil, user_id: 1).id }
          run_test!
        end
